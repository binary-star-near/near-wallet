...
const SendContainerV2 = ({
    ...
    const enterAmountIsComplete = () => {
        return (
            userInputAmount &&
            !new BN(selectedToken.balance).isZero() &&
            isValidAmount()
        );
    };
            ...
            case VIEWS.ENTER_AMOUNT:
                return (
                    <EnterAmount
                        ...
                        onClickSelectToken={() =>
                            setActiveView(VIEWS.SELECT_TOKEN)
                        }
                        error={
                            userInputAmount &&
                            userInputAmount !== "0" &&
            ...
            case VIEWS.ENTER_RECEIVER:
                return (
                    <EnterReceiver
                        ...
                        selectedToken={selectedToken}
                        handleChangeReceiverId={(receiverId) =>
                        ...
                        onClickContinue={() => {
                            Mixpanel.track(
                                "SEND Click continue to review button"
                            );
                            handleContinueToReview({
                                token: selectedToken,
                                rawAmount: getRawAmount(),
